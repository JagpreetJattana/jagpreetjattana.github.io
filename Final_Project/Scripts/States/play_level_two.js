...
(function (states) {
    ...
    var Play_Level_Two = (function () {
        //game variables
        function Play_Level_Two() {
            this.main();
        }
        //method updating play level two state objects
        Play_Level_Two.prototype.update = function () {
            doraemon.update();
        ...
        Play_Level_Two.prototype.main = function () {
        ...
        return Play_Level_Two;
    })();
    states.Play_Level_Two = Play_Level_Two;
})(states || (states = {}));
//# sourceMappingURL=play_level_two.js.map